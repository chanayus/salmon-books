...
gsap
  ...
  .fromTo("#author-image", { autoAlpha: 0, scale: 0.95 }, { autoAlpha: 1, scale: 1, ease: "expo" }, "-=0.25")
  .fromTo("#author-name", { autoAlpha: 0, y: 15 }, { autoAlpha: 1, y: 0, ease: "expo" }, "-=0.25")
  .fromTo("ul li", { autoAlpha: 0, y: 17 }, { autoAlpha: 1, y: 0, stagger: 0.08, ease: "expo" }, "-=0.2")
  .fromTo("#author-social a", { autoAlpha: 0, y: 10 }, { autoAlpha: 1, y: 0, stagger: 0.05, ease: "expo" }, "-=0.35")
